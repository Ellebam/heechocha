...
If you discover a security vulnerability in Hechocha, please report it by opening a private issue or contacting the maintainer directly.

**Please do not open a public issue for security vulnerabilities.**

## Security Considerations

Hechocha is designed with privacy in mind:
...
Hechocha opens tabs to:
- claude.ai (Anthropic)
- gemini.google.com (Google)

These services have their own privacy policies. Hechocha does not transmit any data to these services — it only opens tabs and copies your prompt to your local clipboard.
